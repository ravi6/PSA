...
model plant  
  ...
  constant Real[2] AirComp = {0.767, 0.230};
  ...
  .ThermoS.Uops.Tanks.GasTank TankA(redeclare package Medium = Gas, vol = 1.0);
  .ThermoS.Uops.Tanks.GasTank TankB(redeclare package Medium = Gas, vol = 1.0);
