...
model plant  
  ...
  .ThermoS.Uops.Reservoir sink(redeclare package Medium = .ThermoS.Media.MyAir, p = 2e5, T = 300, Xi = Xstart);
  .ThermoS.Uops.Reservoir atm(redeclare package Medium = .ThermoS.Media.MyAir, p = 1e5, T = 300, Xi = Xstart);
  .ThermoS.Uops.Valves.RealValve vin(redeclare package Medium = .ThermoS.Media.MyAir, vchar = .ThermoS.Uops.Valves.Vchar.Linear, tau = 100e-3);
  .ThermoS.Uops.Valves.RealValve vout(redeclare package Medium = .ThermoS.Media.MyAir, vchar = .ThermoS.Uops.Valves.Vchar.Linear, tau = 100e-3);
  .ThermoS.Uops.Valves.RealValve vbed(redeclare package Medium = .ThermoS.Media.MyAir, vchar = .ThermoS.Uops.Valves.Vchar.Linear, tau = 100e-3);
  .ThermoS.Uops.Valves.RealValve vpurge(redeclare package Medium = .ThermoS.Media.MyAir, vchar = .ThermoS.Uops.Valves.Vchar.Linear, tau = 100e-3);
equation
