...
model bed  
  ...
  .ThermoS.Uops.Valves.RealValve vin(redeclare package Medium = Medium, cv = 44.72e-8, vchar = .ThermoS.Uops.Valves.Vchar.Linear, tau = 2, dpTol = 0.02);
  .ThermoS.Uops.Valves.RealValve vout(redeclare package Medium = Medium, cv = 1.32e-8, vchar = .ThermoS.Uops.Valves.Vchar.Linear, tau = 2, dpTol = 0.02);
  .ThermoS.Uops.Valves.RealValve vblow(redeclare package Medium = Medium, cv = 17.89e-8, vchar = .ThermoS.Uops.Valves.Vchar.Linear, tau = 2, dpTol = 0.02);
...
model plant  
  ...
  constant Real ON = 100;
  constant Real OFF = 100 - ON;
  .ThermoS.Uops.Reservoir src(redeclare package Medium = Medium, p = 1.48e5, T = 300, Xi = Xstart);
  ...
  bed bedA;
  bed bedB;
  .ThermoS.Uops.Valves.RealValve vpurge(redeclare package Medium = Medium, cv = 10.43e-8, vchar = .ThermoS.Uops.Valves.Vchar.Linear, tau = 2, dpTol = 0.02);
initial equation
  bedA.vin.po = OFF;
  bedA.vout.po = ON;
  bedA.vblow.po = OFF;
