...
model bed  
  ...
  .ThermoS.Uops.Valves.RealValve vout(redeclare package Medium = Medium, cv = 0.5 * 1.066 * 0.33 * 1.15 * 2.236e-8, vchar = .ThermoS.Uops.Valves.Vchar.Linear, tau = 2, dpTol = 0.02);
  .ThermoS.Uops.Valves.RealValve vblow(redeclare package Medium = Medium, cv = 0.25 * 89.44e-8, vchar = .ThermoS.Uops.Valves.Vchar.Linear, tau = 2, dpTol = 0.02);
  constant Integer CycleTime = 200;
...
model plant  
  ...
  constant Real ON = 100;
  constant Real OFF = 100 - ON;
  .ThermoS.Uops.Reservoir src(redeclare package Medium = Medium, p = 3.41e5, T = 300, Xi = Xstart);
  ...
  bed bedA;
  bed bedB;
  .ThermoS.Uops.Valves.RealValve vpurge(redeclare package Medium = Medium, cv = 2.236e-8, vchar = .ThermoS.Uops.Valves.Vchar.Linear, tau = 2, dpTol = 0.02);
initial equation
  bedA.vin.po = OFF;
  bedA.vout.po = ON;
  bedA.vblow.po = OFF;
