model bed  
  ...
  .ThermoS.Uops.PSA.Adsorber adsbr(redeclare package Medium = Medium, N = 12);
  constant Real ON = 99.9;
  constant Real OFF = 100 - ON;
  .ThermoS.Uops.Valves.RealValve vin(redeclare package Medium = Medium, cv = 0.04 / sqrt(0.5e5), vchar = .ThermoS.Uops.Valves.Vchar.Linear, tau = 100e-3, dpTol = 100);
  .ThermoS.Uops.Valves.RealValve vout(redeclare package Medium = Medium, cv = 0.004 / sqrt(0.5e5), vchar = .ThermoS.Uops.Valves.Vchar.Linear, tau = 100e-3, dpTol = 100);
  .ThermoS.Uops.Valves.RealValve vpurge(redeclare package Medium = Medium, cv = 0.04 / sqrt(0.5e5), vchar = .ThermoS.Uops.Valves.Vchar.Linear, tau = 100e-3, dpTol = 100);
  constant Integer CycleT = 10;
...
model plant  
  ...
  .ThermoS.Uops.Reservoir srcB(redeclare package Medium = .ThermoS.Media.MyAir, p = 3e5, T = 300, Xi = Xstart);
  .ThermoS.Uops.Reservoir sinkB(redeclare package Medium = .ThermoS.Media.MyAir, p = 1e5, T = 300, Xi = Xstart);
  .ThermoS.Uops.Reservoir atmB(redeclare package Medium = .ThermoS.Media.MyAir, p = 1e5, T = 300, Xi = Xstart);
  bed bedA;
  bed bedB;
initial equation
  bedA.vin.po = OFF;
